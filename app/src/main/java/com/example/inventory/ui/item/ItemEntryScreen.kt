...
fun ItemEntryBody(
    ...
    Column(
        ...
        Button(
            onClick = onSaveClick,
            enabled = itemUiState.actionEnabled, //actionenabled só será verdadeiro se o texto em todos os campos for valido (n vazio)
...
@Composable
fun ItemInputForm(
    itemUiState: ItemUiState, //atualizado com o valor inserido pelo usuário no campo de texto
    modifier: Modifier = Modifier,
